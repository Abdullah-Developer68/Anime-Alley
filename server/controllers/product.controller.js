...
// Validate and convert incoming product fields from multipart/form-data or direct JSON
const validateProductInput = (req) => {
  // Detect multipart/form-data from request headers or multer file attachment
...
const createProduct = async (req, res) => {
  try {
    // Validate and convert incoming product fields in memory before connecting to database
    const validation = validateProductInput(req);
    if (!validation.valid)
